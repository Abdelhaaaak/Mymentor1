...
<div class="max-w-lg mx-auto mt-12 p-8 bg-white bg-opacity-90 rounded-2xl shadow-lg fade-in-up">
  ...
  <form method="POST" action="{{ route('register.mentor.store') }}">
    ...
    <div class="mb-4">
      ...
      <input id="expertise" name="expertise" value="{{ old('expertise') }}"
    ...
    <div class="mb-4">
      ...
      <textarea id="bio" name="bio" rows="3"
                class="mt-1 w-full border rounded px-3 py-2 @error('bio') border-red-500 @enderror">{{ old('bio') }}</textarea>
    ...
    <div class="mb-4">
      ...
      <select id="language" name="language"
              class="mt-1 w-full border rounded px-3 py-2 @error('language') border-red-500 @enderror" required>
    ...
    <div class="mb-4">
      ...
      <select id="level" name="level"
              class="mt-1 w-full border rounded px-3 py-2 @error('level') border-red-500 @enderror" required>
        <option value="">-- Choisir --</option>
    ...
    <div class="mb-6">
      ...
      <input id="style" name="style" value="{{ old('style') }}"
